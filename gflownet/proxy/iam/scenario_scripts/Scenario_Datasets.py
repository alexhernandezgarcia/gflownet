...
class witch_proc_data(Dataset):
    def __init__(
        self,
        subsidies_parquet="witch_processed/subsidies_df.parquet",
        variables_parquet="witch_processed/variables_df.parquet",
        keys_parquet="witch_processed/keys_df.parquet",
        with_cuda=False,
