...
class witch_proc_data(Dataset):
    def __init__(self, subsidies_parquet = 'witch_processed/subsidies_df.parquet', variables_parquet = 'witch_processed/variables_df.parquet', keys_parquet = 'witch_processed/keys_df.parquet', with_cuda=False,
        ...
        if scaling_type not in ['original', 'normalization', 'maxscale']:
    ...
    def __getitem__(self, idx):
        ...
        #next_idx = self.index_map.get((gdx, year + 5, region))
        #variables_next = self.variables_df[next_idx]
