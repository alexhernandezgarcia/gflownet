"""
``gflownet.envs`` package docstring: **todo**.
...
..
    This is an rst comment. It will not be rendered in the final documentation.
    The path in the following ``include`` directive (../../../../gflownet/envs/README.md)
    is relative to the location of the temporary rst created by AutoAPI in:
    ${repo_root}/docs/autoapi/gflownet/envs/index.rst

.. include:: ../../../../gflownet/envs/README.md
