...
if __name__ == '__main__':
    ...
    conf = ConformerBase(test_pos, constants.ad_smiles, constants.ad_atom_types, constants.ad_free_tas)
    ...
    print(tabulate(data, headers=["torsion angle", 'initial value', 'randomized value']))
