...
class MolDGLFeaturizer():
    ...
    def get_node_features(self, mol):
        ...
        for i, atom in enumerate(mol.GetAtoms()):
            ...
            atom_features.append(self.one_hot_encode(atom.GetDegree(), self.atom_degrees))
            # one-hot hybridization
            atom_features.append(self.one_hot_encode(atom.GetHybridization(), self.atom_hybridizations))
