...
# - [0] crystal-lattice system name
# - [1] crystal class indices in the crystal-lattice system
# - [2] point symmetry indices in the crystal system
CRYSTAL_LATTICE_SYSTEMS = {
    1: ["triclinic", [1, 2], [1, 2]],
    2: ["monoclinic", [3, 4, 5], [1, 3, 2]],
    3: ["orthorhombic", [6, 7, 8], [4, 3, 2]],
    4: ["tetragonal", [9, 10, 11, 12, 13, 14, 15], [1, 5, 2, 4, 3]],
    5: ["trigonal-rhombohedral", [16, 17, 18, 19, 20], [1, 2, 4, 3]],
...
# - lattice system indices in the crystal system
# - point symmetry indices in the crystal system
CRYSTAL_SYSTEMS = {
    1: ["triclinic", [1, 2], [1], [1, 2]],
    2: ["monoclinic", [3, 4, 5], [2], [1, 3, 2]],
    3: ["orthorhombic", [6, 7, 8], [3], [4, 3, 2]],
    4: ["tetragonal", [9, 10, 11, 12, 13, 14, 15], [4], [1, 5, 2, 4, 3]],
    5: ["trigonal", [16, 17, 18, 19, 20], [5, 6], [1, 2, 4, 3]],
    6: ["hexagonal", [21, 22, 23, 24, 25, 26, 27], [6], [1, 5, 2, 4, 3]],
    7: ["cubic", [28, 29, 30, 31, 32], [7], [4, 2, 5]],
}
...
# Each item in the dictionary contains a list of:
# - lattice system name
# - crystal system indices in the lattice system
# - point symmetry indices in the lattice system
LATTICE_SYSTEMS = {
    1: ["triclinic", [1], [1, 2]],
    2: ["monoclinic", [2], [1, 3, 2]],
    3: ["orthorhombic", [3], [4, 3, 2]],
    4: ["tetragonal", [4], [1, 5, 2, 4, 3]],
    5: ["rhombohedral", [5], [1, 2, 4, 3]],
...
# Each item in the dictionary contains a list of:
# - point symmetry name
# - crystal-lattice system indices with the point symmetry
# - crystal class indices with the point symmetry
POINT_SYMMETRIES = {
    1: ["enantiomorphic-polar", [1, 2, 4, 5, 6, 7], [1, 3, 9, 16, 21]],
    2: [
        "centrosymmetric",
        [1, 2, 3, 4, 5, 6, 7, 8],
        [2, 5, 8, 11, 15, 17, 20, 23, 27, 29, 32],
    ],
    3: ["polar", [2, 3, 4, 5, 6, 7], [4, 7, 13, 19, 25]],
    4: ["enantiomorphic", [3, 4, 5, 6, 7, 8], [6, 12, 18, 24, 28, 30]],
    5: ["non-centrosymmetric", [4, 7, 8], [10, 14, 22, 26, 31]],
}
...
# Each item in the dictionary contains a list of:
# - [0] point group as in pymatgen
# - [1] crystal class index of the point group
# - [2] crystal system index
# - [3] lattice system index
# - [4] crystal-lattice system index
# - [5] point symmetry index
SPACE_GROUPS = {
    1: ["1", 1, 1, 1, 1, 1],
    2: ["-1", 2, 1, 1, 1, 2],
    3: ["2", 3, 2, 2, 2, 1],
    ...
    121: ["-42m", 14, 4, 4, 4, 5],
    122: ["-42m", 14, 4, 4, 4, 5],
    123: ["4/mmm", 15, 4, 4, 4, 2],
    124: ["4/mmm", 15, 4, 4, 4, 2],
    125: ["4/mmm", 15, 4, 4, 4, 2],
    126: ["4/mmm", 15, 4, 4, 4, 2],
    127: ["4/mmm", 15, 4, 4, 4, 2],
    128: ["4/mmm", 15, 4, 4, 4, 2],
    129: ["4/mmm", 15, 4, 4, 4, 2],
    130: ["4/mmm", 15, 4, 4, 4, 2],
    131: ["4/mmm", 15, 4, 4, 4, 2],
    132: ["4/mmm", 15, 4, 4, 4, 2],
    133: ["4/mmm", 15, 4, 4, 4, 2],
    134: ["4/mmm", 15, 4, 4, 4, 2],
    135: ["4/mmm", 15, 4, 4, 4, 2],
    136: ["4/mmm", 15, 4, 4, 4, 2],
    137: ["4/mmm", 15, 4, 4, 4, 2],
    138: ["4/mmm", 15, 4, 4, 4, 2],
    139: ["4/mmm", 15, 4, 4, 4, 2],
    140: ["4/mmm", 15, 4, 4, 4, 2],
    141: ["4/mmm", 15, 4, 4, 4, 2],
    142: ["4/mmm", 15, 4, 4, 4, 2],
    143: ["3", 16, 5, 6, 6, 1],
    144: ["3", 16, 5, 6, 6, 1],
    145: ["3", 16, 5, 6, 6, 1],
    146: ["3", 16, 5, 5, 5, 1],
    ...
    189: ["-62m", 26, 6, 6, 7, 5],
    190: ["-62m", 26, 6, 6, 7, 5],
    191: ["6/mmm", 27, 6, 6, 7, 2],
    192: ["6/mmm", 27, 6, 6, 7, 2],
    193: ["6/mmm", 27, 6, 6, 7, 2],
    194: ["6/mmm", 27, 6, 6, 7, 2],
    195: ["23", 28, 7, 7, 8, 4],
    196: ["23", 28, 7, 7, 8, 4],
    197: ["23", 28, 7, 7, 8, 4],
    198: ["23", 28, 7, 7, 8, 4],
