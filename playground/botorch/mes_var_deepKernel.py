...
class GPRegressionModel(gpytorch.models.ApproximateGP):
        def __init__(self, num_dim = 256, grid_bounds = (-1., 1.), grid_size = 64, inducing_points = None):
...
class DKLModel(gpytorch.Module):
    def __init__(self, num_dim = 256, grid_bounds = (-1., 1.), grid_size = 64, inducing_points = None):
        ...
        self.gp_layer = GPRegressionModel(num_dim = num_dim, grid_bounds = grid_bounds, grid_size = grid_size, inducing_points=inducing_points)
...
mll = gpytorch.mlls.VariationalELBO(likelihood, model.gp_layer, num_data=train_x.shape[0])
