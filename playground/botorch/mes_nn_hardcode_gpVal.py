...
class NN_Model(Model):
    ...
    def posterior(self, X, observation_noise = False, posterior_transform = None):
        ...
        0.2164])
            covar = tensor([[ 0.3971,  0.1432,  0.0752,  0.1190,  0.0968,  0.0285,  0.0539,  0.1331,
          0.1840,  0.1136],
        [ 0.1432,  0.4083,  0.1268,  0.1114,  0.1529,  0.0644,  0.1024,  0.0922,
          0.0565,  0.0720],
        [ 0.0752,  0.1268,  0.4519,  0.0488,  0.0111,  0.1868,  0.0466,  0.0032,
          0.0749,  0.0554],
        [ 0.1190,  0.1114,  0.0488,  0.4502,  0.0554,  0.1033,  0.0423,  0.0672,
          0.0561,  0.0927],
        [ 0.0968,  0.1529,  0.0111,  0.0554,  0.3883,  0.0018,  0.1694,  0.2801,
          0.0347,  0.0518],
        [ 0.0285,  0.0644,  0.1868,  0.1033,  0.0018,  0.4678,  0.0353, -0.0046,
          0.0198,  0.0572],
        [ 0.0539,  0.1024,  0.0466,  0.0423,  0.1694,  0.0353,  0.4511,  0.0652,
          0.0329,  0.1015],
        [ 0.1331,  0.0922,  0.0032,  0.0672,  0.2801, -0.0046,  0.0652,  0.4125,
          0.0540,  0.0325],
        [ 0.1840,  0.0565,  0.0749,  0.0561,  0.0347,  0.0198,  0.0329,  0.0540,
          0.4292,  0.2044],
        [ 0.1136,  0.0720,  0.0554,  0.0927,  0.0518,  0.0572,  0.1015,  0.0325,
          0.2044,  0.4287]])
        elif X.ndim==4:
            #10 x 1
            mean = tensor([[[0.0656]], 
