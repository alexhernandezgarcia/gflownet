...
def add_args(parser):
    ...
    parser.add_argument("--bandwidth", default=0.1, type=float)
...
def main(args):
    ...
    gflownet.logger.test.kde.bandwidth = args.bandwidth
    l1, kl, jsd, figs = gflownet.test(alpha=args.alpha, colorbar=args.colorbar)
    # Save figures
